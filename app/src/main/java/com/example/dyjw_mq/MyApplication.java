...
public class MyApplication extends Application {
    public static final String APP_ID = "64402a1f7a"; // TODO 替换成bugly上注册的appid
    public static final String APP_CHANNEL = "dyjw"; // TODO 自定义渠道
    ...
    public void onCreate() {
         ...
         */
        Beta.largeIconId = R.drawable.oil;

        /**
         * 设置状态栏小图标，smallIconId为项目中的图片资源id;
         */
        Beta.smallIconId = R.drawable.oil;
         ...
         */
        Beta.defaultBannerId = R.drawable.oil;;
